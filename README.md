Continuous Integration (CircleCI) [![Circle CI](https://circleci.com/gh/cmusv-fse/s18-CI-CD/tree/master.svg?style=svg)](https://circleci.com/gh/cmusv-fse/s18-CI-CD/tree/master)
==============
